...
SITE_TITLE = "Treasury Committee — News"
SITE_LINK  = "https://committees.parliament.uk/committee/158/treasury-committee/news/"
START_URL  = SITE_LINK
...
def main():
    ...
    xml = rss2(items)
    with open("feed_treasury.xml", "w", encoding="utf-8") as f:
        f.write(xml)
